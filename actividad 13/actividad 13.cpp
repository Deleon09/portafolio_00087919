...
bool buscarEspanol() {
	...
	while(s != NULL && (s->dato).espanol != unespanol)
        s = s->sig;
    
    return (s != NULL);
}

void eliminarLibrosdemisterio(){
    ...
    if(p == NULL){
        cout << "No hay libros de misterio para borrar" << endl;
        return;
    }
    if(q == NULL)
        pInicio = p->sig;
...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
            case 5: cout << "Buscando Libros de ciencia ficcion..." << endl;
                if(buscarCiencia_ficcion())
                    cout << "Si hay libros de ciencia ficcion" << endl;
                else 
                    cout << "No hay libros de ciencia ficcion" << endl;
            break;
			case 6: cout << "Buscando Libros en espanol..." << endl;
			    if(buscarEspanol())
