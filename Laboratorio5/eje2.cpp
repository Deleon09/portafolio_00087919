...
cout<<endl;
    cout << "Recorrido IN orden de menor a mayor:"; inorden(a); cout << endl;
  
}

void recorrerArbolespejo(Arbol a){
cout<<endl;
    cout << "Recorrido IN orden de mayor a menor:"; inordenespejo(a); cout << endl;
